...
const House = ({house}) => {
  ...
  return (
    <div className='bg-white shadow-1 p-5 rounded-lg rounded-tl-[10px] w-full max-w-[352px] mx-auto cursor-pointer hover:shadow-2xl transition'>
      <img className='mb-8 rounded-md' src={house.image} alt='' />
      ...
      <div className='text-base font-semibold max-w-[260px]'>{house.address}</div>
